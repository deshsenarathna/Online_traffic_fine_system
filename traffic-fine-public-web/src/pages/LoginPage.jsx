  ...
  return (
    <>
      <style>{`
        ...
        .login-field:focus-within label { color: #16b89d; }
        .login-input {
          width: 100%;
          padding: 13px 14px;
        ...
        .login-input::placeholder { color: #aab8c5; }
        .login-btn {
          width: 100%;
          padding: 15px;
          border: none;
      ...
      <div style={s.page}>
        <div style={s.card}>
          ...
          <h1 style={s.heading}>Officer Sign In</h1>
          <p style={s.subtitle}>
          ...
          <form onSubmit={handleSubmit} noValidate style={{ marginTop: "28px" }}>
            {/* Username */}
            <div className="login-field" style={s.fieldWrap}>
              <label style={s.label} htmlFor="lp-username">Username</label>
            ...
            {/* Password */}
            <div className="login-field" style={s.fieldWrap}>
              <label style={s.label} htmlFor="lp-password">Password</label>
              <div style={s.inputWrap}>
                <span style={s.inputIcon}>
                  <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="#829ab1" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
