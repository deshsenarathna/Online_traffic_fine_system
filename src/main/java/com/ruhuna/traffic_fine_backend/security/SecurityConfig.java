...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/fines/create").permitAll()
    ...
    /**
     * CORS configuration — allows requests from the frontend dev server.
     */
    @Bean
    ...
    /**
     * DAO authentication provider using BCrypt password hashing.
     */
    @Bean
